...
payload = ""
headers = {"Authorization": "Bearer jina_a244774ca9af4fa09e60e3821423c40dyiQtsxGm0ljFVsU-NjX1JqIDKHEF"}
...
for slug in slugs[1651:1950]:  # Limit to first 150 slugs
    url = base_url + slug
    ...
    counter += 1
    if counter % 5 == 0:
        percentage_done = (counter / 300) * 100
